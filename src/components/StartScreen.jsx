...
function StartScreen({ state, dispatch }) {
  ...
  return (
    <div className=" space-y-5 text-center">
      ...
      <div className=" w-[100dvw] p-1 flex flex-col justify-center items-center rounded-md  space-y-14">
        <div className="space-y-8">
          ...
          <div className=" gap-3   flex flex-col md:flex-row lg:flex-row xl:flex-row ">
            <button
              onClick={(e) =>
                dispatch({ type: "submitLevel", payload: e.target.value })
              }
        ...
        <div className="space-y-8">
          ...
          <input
            ...
            onChange={(e) =>
              dispatch({ type: "submitName", payload: e.target.value })
            }
            type="text"
        ...
        <div className="text-center md:text-end lg:text-end xl:text-end">
          <button
            onClick={() => {
              if (!name || !level)
                return alert("Please Select Valid Level Or Enter Name");
